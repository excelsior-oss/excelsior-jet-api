...
public class DependencySettingsResolverTest {
    ...
    @Test
    public void testDefaultsForLib() throws Exception {
    ...
    @Test
    public void testDefaultsForNonLib() throws Exception {
        DependencySettings settings = DependencyBuilder.testDependencySettings().isLib(false).asDependencySettings();
        DependencySettingsResolver dependencySettingsResolver = new DependencySettingsResolver("groupId", Collections.singletonList(settings));
        ProjectDependency dep = DependencyBuilder.testProjectDependency(new File("/dep")).asProjectDependency();
        ClasspathEntry resolvedDep = dependencySettingsResolver.resolve(dep);
    ...
    public void testThatArtifactSettingsOverwritesGroupSettings() throws Exception {
        ...
        DependencySettingsResolver dependencySettingsResolver = new DependencySettingsResolver("prjGroupId", asList(groupSettings, artifactSettings));
    ...
    public void testThatGroupWithVersionSettingsOverwritesGroupSettings() throws Exception {
        ...
        DependencySettingsResolver dependencySettingsResolver = new DependencySettingsResolver("prjGroupId", asList(groupSettings, groupWithVersionSettings));
